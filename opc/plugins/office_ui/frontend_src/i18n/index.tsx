...
const en = {
  ...
  'project.slugPreview': 'Will be created as "{slug}"',
  'project.createButton': 'Create',
  'project.workplace': 'Workplace directory',
  'project.workplacePlaceholder': '/path/to/your/project',
  'project.workplaceHint': 'Agents will read and write files in this directory. Leave empty to use the default.',
  'project.workplaceSource.default': 'Default',
  'project.workplaceSource.env': 'From OPC_WORKPLACE_ROOT',
  'project.workplaceSource.manual': 'Custom',
  'project.workplaceSave': 'Save',
  'project.workplaceReset': 'Reset to default',
  'project.workplaceOptional': '(optional, uses default if empty)',
...
const zh: Record<MessageKey, string> = {
  ...
  'project.slugPreview': '将创建为 "{slug}"',
  'project.createButton': '创建',
  'project.workplace': '工作目录',
  'project.workplacePlaceholder': '/path/to/your/project',
  'project.workplaceHint': 'Agent 将在此目录中读写文件。留空则使用默认路径。',
  'project.workplaceSource.default': '默认',
  'project.workplaceSource.env': '来自 OPC_WORKPLACE_ROOT',
  'project.workplaceSource.manual': '自定义',
  'project.workplaceSave': '保存',
  'project.workplaceReset': '重置为默认',
  'project.workplaceOptional': '（可选，留空使用默认路径）',
  'common.cancel': '取消',
  'common.delete': '删除',
  'common.yes': '是',
  'common.no': '否',
